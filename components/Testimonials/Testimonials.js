    ...
    <Container>
      ...
      >
        <div className={classes.root}>
          ...
          <Title dark>
            {t('common:unisex-landing.testi_title')}
            &nbsp;
            <strong>
              {t('common:unisex-landing.testi_titleBold')}
            </strong>
          </Title>
          <Grid container>
            ...
            <Grid item md={5} xs={12}>
              <div className={classes.text}>
                ...
                >
                  ...
                  >
                    {t('common:unisex-landing.testi_title2')}
                  </Typography>
                </ScrollAnimation>
                <ScrollAnimation
                  animateOnce
...
export default withTranslation(['unisex-landing'])(Testimonials);
