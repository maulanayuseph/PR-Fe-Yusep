    ...
    <div className={classes.setting}>
      ...
      >
        <List
          ...
          subheader={(
            <ListSubheader component="div">
              {t('common:unisex-landing.header_theme')}
            </ListSubheader>
          )}
        >
          <ListItem>
            <Typography component="div">
              <Grid container alignItems="center" spacing={1}>
                <Grid item>
                  {t('common:unisex-landing.header_light')}
                </Grid>
                <Grid item>
                  <Switch
                    checked={isDark}
                ...
                <Grid item>
                  {t('common:unisex-landing.header_dark')}
                </Grid>
              </Grid>
            </Typography>
          </ListItem>
        ...
        <List
          ...
          subheader={(
            <ListSubheader component="div">
              {t('common:unisex-landing.header_language')}
            </ListSubheader>
          )}
        >
...
export default withTranslation(['common', 'unisex-landing'])(Settings);
